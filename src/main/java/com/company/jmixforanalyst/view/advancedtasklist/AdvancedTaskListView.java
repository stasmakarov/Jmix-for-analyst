package com.company.jmixforanalyst.view.advancedtasklist;
...
@ViewController(id = "jal_AdvancedTaskListView")
@ViewDescriptor(path = "advanced-task-list-view.xml")
public class AdvancedTaskListView extends StandardListView<TaskData> {
